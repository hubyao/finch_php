...
<form class="layui-form login-form" action="<?php echo $this->url('login/loginHandle');?>" method="post">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			...
			<img title="看不清？换一张" src="<?php echo $this->url('login/verify',array('m'=>'adminlogin'));?>" onclick="this.src='<?php echo $this->url('login/verify',array('m'=>'adminlogin'));?>?'+Math.random();"/>
		</div>
	</div>
	<div class="layui-form-item">
		<div class="layui-input-block">
