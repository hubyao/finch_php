...
<div class="layui-body">
	...
	<div class="layui-tab layui-tab-brief">
		<ul class="layui-tab-title">
			<li class="layui-this">管理员中心</li>
			<li><a href="<?php echo $this->url('useradmin/add');?>">添加管理员</a></li>
		</ul>
			...
			<div class="layui-tab-item layui-show">
				<table class="layui-table">
					...
					<tr>
						...
						<td nowrap>
							<a href="<?php echo $this->url('useradmin/add',['id'=>$v['id']]);?>" class="layui-btn layui-btn-mini edit_category">修改</a>
							<a href="#" data-url="<?php echo $this->url('useradmin/delete',['id'=>$v['id']]);?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
						</td>
					</tr>
					<?php } ?>
					</tbody>
